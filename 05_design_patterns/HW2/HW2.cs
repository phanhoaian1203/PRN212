...
namespace DesignPatterns.Homework { // This homework is based on the Singleton Pattern with a practical application // You will implement a basic logging system using the Singleton pattern

public class Logger
{
    // Private static instance of the Logger class (nullable to avoid CS8618 warning)
